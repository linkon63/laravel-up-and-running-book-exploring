            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <!-- test table -->
                        <h1 class="p-4 text-2xl">Your Post DB</h1>
...
const updateFormSubmit = () => {
    ...
    console.log("Inner submit", updateForm.title, updateForm.description);
    router.patch("/post", updateForm);
};
const deletePost = (id) => {
